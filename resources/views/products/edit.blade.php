                ...
                <div id="list-view" class="tab-pane fade active show col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ __('translation.edit_product')}}</h4>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                            class="form-control" value="{{ $product->title}}" name="title_ar" id="" aria-describedby="helpId" placeholder="">
                                                            @error('title_ar')
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea type="text"
                                                            class="form-control"   name="description_ar" id="" aria-describedby="helpId" placeholder=""> {{ $product->description}}</textarea>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                            class="form-control" value="{{ $product->getTranslation('description' , 'en')}}" name="title_en" id="" aria-describedby="helpId" placeholder="">
                                                            @error('title_ar')
                                                            <span class="danger-text" style='color:red'">
                                                                {{$message}}
                                                            </span>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea type="text"
                                                            class="form-control" name="description_en" id="" aria-describedby="helpId" placeholder="">
