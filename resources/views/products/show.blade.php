                ...
                <div class="row tab-content">
                    <div id="list-view" class="tab-pane fade active show col-lg-12">
                        <div class="card">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{ __('translation.product_show') }}</h4>
                                </div>
                                <div class="card-body">
                                    <ul class="nav nav-pills mb-4">
                                        <li class=" nav-item">
                                            <a href="#navpills-1" class="nav-link active" data-toggle="tab"
                                                aria-expanded="false">{{ __('translation.prodcut_info') }}</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#navpills-2" class="nav-link" data-toggle="tab" aria-expanded="false">
                                                {{ __('translation.product_attachments') }}</a>
                                        </li>
                                            ...
                                            <div class="row">
                                                <table id="example3" class="display dataTable no-footer"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @forelse ($product->Iamges as $key =>  $image)
                                                            <tr role="row" class="odd">
                                                                <td>{{ $key + 1 }}</td>
                                                                <td> <img width="70" src="{{ asset($image->image_name) }}"
                                                                        alt="Product Main Imge"> </td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="{{ route('admin.product.show', $product->id) }}"
                                                                        class="btn btn-sm btn-outline-info"><i
                                                                            class="la la-eye"></i></a> --}}
                                                                    <form
                                                                        action="{{ route('admin.product.destroy',['product' =>  $image->id ,  'type' => 'file' ,  'attach_id' => $image->id]) }}"
                                                                        method="post" style="display: inline-block">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button class="btn btn-sm btn-danger"><i
